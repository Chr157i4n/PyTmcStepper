...
class MicroPythonGPIOWrapper(BaseGPIOWrapper):
    """MicroPython GPIO wrapper for Raspberry Pi Pico (RP2040) and similar
    boards.

    Uses machine.Pin and machine.PWM for GPIO control. Only available
    when running under MicroPython.
    """
